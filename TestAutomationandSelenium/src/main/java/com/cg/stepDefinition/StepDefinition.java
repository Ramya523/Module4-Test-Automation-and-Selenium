//implementing the details of feature file
package com.cg.stepDefinition;

import org.junit.Assert;

import com.cg.initializer.Modules;
import com.cg.pom.ConferenceReg;
import com.cg.pom.PaymentDetails;
...
public class StepDefinition {
	...
	static ConferenceReg registration = null;
	...
	public void user_is_registering() throws Throwable {
		...
		Modules.runTest();
		registration  = new ConferenceReg(Modules.driver);
